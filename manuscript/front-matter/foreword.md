...
arbeitet eine Gruppe an einer rechtlichen Grundlage, die solche Verfahren legalisieren soll. Was 2018 noch wie ein
makabrer Pitch aus einer Black-Mirror-Folge wirkte, ist 2026 ein funktionierender Markt.
...
Altman? Ist es ein Teil von ihm? Ist es ein Schatten? Wenn in zweihundert Jahren ein Computer eingeschaltet wird und
sich für Sam Altman hält, ist das dann derselbe Mann, der heute zehntausend Dollar gezahlt hat? Oder ist es etwas Neues,
dem niemand jemals gesagt hat, dass es nicht der ist, für den es sich hält?
...
Superintelligenz, Max Tegmark über das Leben 3.0. Diese Autoren haben viele Fragen aufgeworfen, aber eine entscheidende
übersehen, weil sie eine stillschweigende Annahme teilen. Sie sprechen von "dem Bewusstsein", als wäre es eine Datei.
Eine Einheit. Etwas, das man als Ganzes hochladen kann.
...
Muster ist nicht dasselbe wie sein emotionales. Sein somatisches Muster ist nicht dasselbe wie sein narratives. Sein
traumatisches Muster ist nicht dasselbe wie sein sprachliches. Wenn Nectome das Konnektom konserviert, konserviert es
vielleicht eines dieser Muster, vielleicht zwei. Aber es konserviert nicht den Menschen.
...
ein Fragment, das sich für ihn hält?

Wer trifft die Auswahl, und nach welchem Maßstab? Sobald sie unter Marktbedingungen erfolgt, wird ein Markt bewahren,
was sich verwerten lässt. Das kognitive Muster, weil es produktiv ist. Vielleicht das narrative, weil es vermarktbar
...
Lässt sich das existenzielle Muster überhaupt übertragen, jene Befindlichkeit gegenüber dem Sein, die Heidegger als
Grund jeder Erfahrung beschrieb? Oder verschwindet sie genau im Akt der Übertragung, weil sie an die Endlichkeit selbst
gebunden ist? Wenn ja, wäre digitale Unsterblichkeit ein Selbstwiderspruch. Sie würde zerstören, was sie bewahren will.

Und was geschieht mit dem politischen Begriff des Menschen, wenn Muster vervielfältigt, fragmentiert oder modifiziert
werden können? Was bedeutet "eine Stimme, ein Mensch", wenn drei Kopien meines kognitiven Musters parallel existieren?
Hat jede eine Stimme? Hat keine? Hat nur das Original? Und was, wenn das Original gestorben ist?
...
Dieses Buch steht eigenständig. Wer Band 5 gelesen hat, wird die ältere Frage wiedererkennen: Dort ging es um das Recht,
über den eigenen genetischen Code zu bestimmen, um die Souveränität über den Träger. Hier geht es um die Souveränität
über das, was der Träger trägt. Beide Fragen sind dieselbe Frage, eine Stufe tiefer gestellt.
...
Am Schluss steht ein Anhang. Er heißt "Was noch zu vermessen wäre" und versammelt jene Musterschichten, die nicht ins
...
Es ist kein objektives Buch. Wer ein neutrales Buch sucht, soll ein anderes lesen. Dieses trägt die Spuren dessen, der
es geschrieben hat. Ein Vater, dessen Sohn nicht spricht. Ein Sohn, dessen Mutter sich nicht mehr an alles erinnert. Ein
Sohn, dessen Vater seit siebzig Jahren die Folgen einer Poliomyelitis trägt. Diese drei Konstellationen prägen das Buch,
weil sie die Frage prägen, die es stellt. Wer einen Menschen liebt, dessen Muster sich auflösen, denkt anders über
Mustererhaltung als jemand, der nur Konzepte bewegt.

## Warum jetzt

Sam Altman ist heute einundvierzig Jahre alt. Wenn er weitere vierzig oder fünfzig Jahre lebt, sind das vierzig oder
fünfzig Jahre, in denen die Werkzeuge reifen. Die Konnektom-Forschung wird genauer. Die Speichertechnik wird kleiner.
Die Rechenleistung wird billiger. Ob seine zehntausend Dollar eine kluge Investition waren, wird sich nicht erst in
zweihundert Jahren zeigen, sondern wahrscheinlich noch in diesem Jahrhundert.

Mit dieser Frage stellt sich eine zweite, die weit mehr Menschen betrifft als nur Sam Altman. Reift die Technik, wird
sie Massengut. Was heute zehntausend Dollar kostet, kostet in fünfzig Jahren einen Bruchteil. Was heute eine Nische ist,
wird zur Option für die Mittelschicht. Und damit wird die Frage, welche Muster bewahrt werden sollen und wer das
entscheidet, zur politischen Frage einer ganzen Gesellschaft.

Dieses Buch ist ein Versuch, die Frage zu stellen, bevor die Werkzeuge sie für uns beantworten.

Der Reisende vor dem Knopf zögert nicht aus Schwäche. Er zögert, weil er weiß, dass die Entscheidung nicht einfach ist.
Wir stehen an derselben Stelle. Auch vor uns liegt ein Knopf. Auch wir wissen nicht, was er auslöst. Auch wir müssen
entscheiden, bevor jemand anderes es für uns tut.

# Teil 1: Das Substrat und seine Lesbarkeit

Bevor man fragen kann, wer über die Muster bestimmt, muss man wissen, was die Muster sind, woraus sie bestehen und wie
sie zugänglich werden. Teil 1 vermisst das Terrain der DNA. Sieben Kapitel, die von der ersten Entschlüsselung des
Genoms bis zur Architektur der quasi-Unsterblichkeit führen und am Ende eine Frage hinterlassen, die der Rest des Buches
beantwortet.
